...
public class DZMenuComponents implements IMenuComponentFactory {
     ...
     */
    @Override
    public void Switch(LinearLayout linLayout, final int featNum, final String featName, final  boolean swiOn)
    {
     ...
     */
    @Override
    public void SeekBar(LinearLayout linLayout, final int featNum, final String featName, final  int min, int max) {
     ...
     */
    @Override
    public void CheckBox(LinearLayout linLayout, final int featNum, final String featName, final  boolean switchedOn) {
     ...
     */
    @Override
    public void Collapse(LinearLayout linLayout, final String text, boolean expanded) {
